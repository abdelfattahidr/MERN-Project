...
export default function CommentSection({ postId }) {
     ...
     const handleEdite = async (comment, editeContent) => {
          setComments(
               comments.map((c) => (c._id === comment._id ? { ...c, content: editeContent } : c))
          )
     }
          ...
          <Modal show={showModal} onClose={() => setShowModal(false)} popup size='md'>
               ...
               <Modal.Body>
                    <div className="text-center">
                         ...
                         <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure to delete this Comment?.</h3>
                    </div>
               </Modal.Body>
